...
-- ! [사전작업] temp 데이터베이스에 아파트 크롤링 sql문 돌리기 
...
insert into sonpum.address (addressId, dongCode, roadName, roadNameBonbun, roadNameBubun)
select houseinfo.aptCode, houseinfo.dongCode, houseinfo.roadName, houseinfo.roadNameBonbun, houseinfo.roadNameBubun
from temp.houseinfo;
