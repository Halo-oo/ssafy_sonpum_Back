...
insert into house_product (userId, addressId, floor, buildYear, dealAmount, area, dealType, content)
values ('realrent', 11680000000111, '14', '1992', '3400,000', '135.82', 'SALE', '특올수리 41 최고물건  상담환영'); 
insert into house_product (userId, addressId, floor, buildYear, dealAmount, area, dealType, content)
values ('realrent', 11680000000111, '24', '1995', '101,000', '101.22', 'MONTH', '39. 방4 화장실2  실내깔금 입주협의'); 
select * from house_product;
